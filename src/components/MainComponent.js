...
const mapDispatchToProps = {
    ...
    postFeedback: (campsiteId, rating, author, text) => (postFeedback(campsiteId, rating, author, text))
};
        ...
        const HomePage = () => {
            return (
                <Home 
                    ...
                    // the 1st promotions points to the promotions object. the 2nd promotions points to the promotions array inside the object
                    ...
                    <TransitionGroup>
                        <CSSTransition key={this.props.location.key} classNames="page" timeout={300}>
                            <Switch>
                                ...
                                <Route exact path='/feedback' render={() => <Contact postFeedbackForm={this.props.postFeebackForm} />} />
                                <Redirect to='/home'/>
                            </Switch>
                        </CSSTransition>
                    </TransitionGroup>
